...
class KnowledgeBaseQA:
    ...
    def build_prompt(question: str, contexts: List[Dict]) -> str:
        ...
        instruction = (
            ...
            "如果用户问题没有指明具体情况，有多个参考内容可以用来回答该问题，这时你要说：这要以情况而定，然后把所有可能的答案（住院/门诊，城镇职工/城乡居民，不同病种的具体情况）列出来。"
            "例如用户只问了慢性病待遇，参考内容中有城镇职工门诊慢性病待遇、城镇职工住院慢性病待遇、城乡居民住院慢性病待遇等多种情况时，要全部返回给用户。"
